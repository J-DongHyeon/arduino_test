...
void loop() {
  ...
  phi += (gyX_cal + gyY_cal * sin(phi * PI / 180) * tan(theta * PI / 180) + gyZ_cal * cos(phi * PI / 180) * tan(theta * PI / 180)) * dt;
  theta += (gyY_cal * cos(phi * PI / 180) - gyZ_cal * sin(phi * PI / 180)) * dt;
  psi += ((gyY_cal * sin(phi * PI / 180) + gyZ_cal * cos(phi * PI / 180)) / cos(theta * PI / 180)) * dt;
